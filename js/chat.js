...
fab.addEventListener("click", () => {
  ...
  if (panel.classList.contains("open")){
    ...
    if (!greeted){
      greeted = true;
      add("bot", "Мяу! Я Момо — веду этот магазин. Спрашивайте про модули, цены, доставку, вашу сборку в конфигураторе — или про умную игрушку с игровыми сценариями. Отвечаю честно: я ИИ, но в домиках разбираюсь.");
      health();
    }
  }
});
