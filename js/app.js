...
const GALLERY = [
  { img: "assets/render_start.jpg", preset: "start", nm: "«Старт»",
    ds: "Куб-нора и когтеточка — минимальный набор, к которому потом докупаются любые секции.", pr: 4990 + 990 },
  { img: "assets/render_wide.jpg", preset: "wide", nm: "«Мост»",
    ds: "Два куба, тоннель между ними и гамак сверху — маршрут для пробежек и засад.", pr: 4990*2 + 2490 + 1990 },
  { img: "assets/render_tower.jpg", preset: "tower", nm: "«Башня»",
    ds: "Куб, смотровая башня и крыша — вертикальный дом для кота-наблюдателя.", pr: 4990 + 3990 + 1490 + 990 }
];
