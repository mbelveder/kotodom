...
KD.MODULES = {
  ...
  play: {
    ...
    desc: "Полусферическая чаша на опоре — уютное гнездо, где свернётся один кот, а то и два. Ставится на пол или на модуль.",
    needsSupport: false, supportsAbove: false, isRoof: false, hasEntrance: false,
...
KD.PRESETS = {
  ...
  manor: { name: "Резиденция",
    ...
    say: "Два куба с тоннелем, гамак, башня с крышей, когтеточка и чаша-лежанка на сдачу — целая резиденция." },
  watch: { name: "Дозорный",
