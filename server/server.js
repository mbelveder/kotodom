...
const CATALOG = {
  ...
  scratch:{ name:"Когтеточка", price:690 }, play:{ name:"Чаша-лежанка", price:2440 }
};
...
• Чаша-лежанка — 2 440 ₽: полусферическая чаша из прозрачного акрила с непрозрачным ободком на высокой опоре — гнездо, приподнятое над полом; ставится на пол или на модуль.
