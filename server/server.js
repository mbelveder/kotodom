...
const CATALOG = {
  ...
  hammock:{ name:"Гамак", price:1990 }, hammock2:{ name:"Гамак широкий", price:2990 },
  roof:{ name:"Крыша", price:1490 },
  scratch:{ name:"Когтеточка", price:990 }, play:{ name:"Умная игрушка", price:3490 }
};
...
• Гамак широкий — 2 990 ₽: двойной, крепится над двумя соседними закрытыми модулями.
• Крыша — 1 490 ₽: двускатная, завершает постройку.
• Когтеточка — 990 ₽: столбик в джуте, ставится на пол.
• Умная игрушка — 3 490 ₽: дразнилка-робот с пёрышком; игровые сценарии («охота перед ужином», «разминка в обед») запускаются из приложения или голосовым ассистентом; заряда хватает ~на 2 недели, зарядка USB-C; ставится на пол или на модуль.
